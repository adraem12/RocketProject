...
namespace AerodynamicObjects
{
    ...
    {
        /// <summary>
        /// Calculates the vector velocity of wind using speed, angle about the Y axis in degrees (azimuth), and elevation angle in degrees.
        /// </summary>
        ...
        public static Vector3 GetVelocity(float speed, float azimuth, float elevation)
        {
